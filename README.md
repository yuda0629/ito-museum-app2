...
動作要件
バージョンPython3.9 以上R4.0 以上pip / CRAN パッケージrequirements.txt / install.packages() 参照
構成
.
...
R 版
rinstall.packages(c("shiny", "leaflet", "dplyr"))
shiny::runApp("app.R")
起動後、コンソールに表示される http://127.0.0.1:<ポート> をブラウザで開いてください。
技術スタック
技術PythonStreamlit / Folium / pandasRShiny / leaflet地図タイルOpenStreetMap
🛠️ 技術的な詳細と工夫
